                ...
                <div class="col-md-4">
                    <div class="card video-card p-3 border-0 h-100">
                        <div class="video-thumb-wrapper position-relative mb-3">
                            <?php if ($video_thumb): ?>
                                <img class="img-fluid" src="<?php echo esc_url($video_thumb['url']); ?>"
                                    alt="<?php echo esc_attr($video_thumb['alt']); ?>">
                            <?php endif; ?>
        ...
        <div class="modal-content bg-black border-0">
            <div class="modal-body p-0 position-relative">
                ...
                <div class="ratio ratio-16x9">
                    <iframe id="videoIframe" class="w-100 h-100" src="" frameborder="0"
